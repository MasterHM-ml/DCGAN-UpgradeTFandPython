...
class DCGAN(object):
  ...
  def build_model(self):
    ...
    self.G: tf.keras.Sequential = self.generator(self.z, self.y)
  ...
  def discriminator(self, image,):
    ...
    model.add(tf.keras.layers.Conv2D(self.df_dim, (5,5), (2,2), "same", use_bias=True, input_shape=image.shape,
